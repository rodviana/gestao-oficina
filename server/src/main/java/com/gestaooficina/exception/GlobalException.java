...
public class GlobalException extends RuntimeException {
    ...
    public static GlobalException fromUserProcedure(int errorCode, String procedureMessage) {
        switch (errorCode) {
            case 1:
                return of(ValidationMessageEnum.EMAIL_ALREADY_REGISTERED);
            case 2:
                return of(ValidationMessageEnum.INVALID_ROLE);
            case 3:
                return of(ValidationMessageEnum.EMAIL_REQUIRED);
            default:
                return of(ValidationMessageEnum.FAILED_CREATE_USER);
        }
    }
}
