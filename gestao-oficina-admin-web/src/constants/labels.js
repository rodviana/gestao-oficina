...
/** Barra de destaque lateral dos cards do kanban, por status. */
export const WorkOrderStatusAccent = Object.freeze({
  OPEN: 'bg-ink-400',
  IN_PROGRESS: 'bg-sky-500',
  WAITING_PARTS: 'bg-amber-500',
  READY: 'bg-emerald-500',
  DELIVERED: 'bg-ink-300',
...
export const PaymentStatusShortLabel = Object.freeze({
  UNPAID: 'Não pago',
  WAITING_PAYMENT: 'Aguard. pgto',
  PAID: 'Pago',
});

export const PaymentStatusTone = Object.freeze({
  UNPAID: 'bg-red-100 text-red-700',
  WAITING_PAYMENT: 'bg-amber-100 text-amber-900',
