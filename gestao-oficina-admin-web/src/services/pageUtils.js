...
/**
 * Carrega todas as páginas (uso restrito: analytics/dashboard).
 * pageMaxNumber é zero-based.
 */
export async function fetchAllPages(fetchPage, { pageSize = DEFAULT_PAGE_SIZE, maxPages = 50 } = {}) {
  const all = [];
  let page = 0;
  let pageMaxNumber = 0;
